...
const Signin = () => {
  return (
    <div className="sign-in">
      ...
      <main>
        <div className="firstsec">BASE</div>
        <div className="secondsec">
          <form>
            <h1 className="font-bold text-left">Sign In</h1>
            <h3 className="text-left font-400">Sign in to your account</h3>
            <div>
              <div className="sm:gap-1 mx-2 flex justify-between md:gap-12 m-8">
                <button className="flex items-center gap-6 text-gray-400">
                  <img src={google} alt="google icon" />
                  <span className="sm:text-xs">Sign in with Google</span>
                </button>
                <button className="flex items-center gap-6 text-gray-400">
              ...
              <div className="mt-10 text-left sm:mx-auto sm:w-full form-style">
                <form className="space-y-6" action="#" method="POST">
                  <div>
                    ...
                    <div className="mt-2">
                      <input
                        ...
                        autocomplete="email"
                        required
                        className="block w-full rounded-lg border-none bg-gray-150 py-5 text-gray-900 shadow-sm placeholder:text-gray-400 focus:ring-0 focus:bg-gray-250 sm:text-sm sm:leading-6"
                      />
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="mt-2">
                      <input
                        ...
                        required
                        className="block w-full rounded-md border-none bg-gray-150 py-5 text-gray-900 shadow-sm placeholder:text-gray-400 focus:ring-0 focus:bg-gray-250 sm:text-sm sm:leading-6"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="flex w-full justify-center rounded-lg bg-primary p-5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                    >
                      Sign in
                    </button>
                  </div>
                ...
                <p className="mt-16 text-center text-sm text-gray-500 flex flex-col justify-center gap-6 sm:gap-0 items-center sm:flex-row">
                  Don't have an account?
                  <a
                    href="/"
                    className="leading-8 ms-4 text-primary hover:text-indigo-500"
                  >
                    Register here
                  </a>
                </p>
